...
namespace wf_restaurante
{
    public partial class Form1 : Form
    {
        ...
        ICollection<Control> buttons;
        Control moveableItem;
        bool down = false;
        Point initial;
        private readonly ITableSvc tableSvc;

        public Form1(ITableSvc tableSvc)
        {
            InitializeComponent();
        ...
        private void PictureBox1_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                MoveableTable table = CreateMoveableTable(sender as Control);
                table.CurrentPosition = e.Location; 
            }
        }
        ...
        private MoveableTable CreateMoveableTable(Control ctr)
        {
            return (MoveableTable)ctr;
        }
    }
}
